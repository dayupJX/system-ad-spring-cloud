...
@Slf4j
@Component
public class UnitDistrictIndex implements IndexAware<String, Set<Long>> {//这里有必要构造Set<Long>集合吗？ 有,因为get()方法
    ...
    public boolean match(Long adUnitId, List<DistrictFeature.ProvinceAndCity> districts) {
        if ( CollectionUtils.isNotEmpty(unitDistrictMap.get(adUnitId))) {
